...
<footer class="flex flex-col w-screen bg-stappatored-three text-background-three">
	...
	<div class="flex items-start">
		<div
			class="flex flex-col sm:flex-row sm:flex-wrap lg:grid-cols-4 w-screen {padding} {paddingY} justify-center sm:justify-start gap-10 md:gap-20 items-start"
		>
			<!-- Items -->
			...
			<div class="flex flex-col gap-2 tracking-[1px]">
				...
				<a href={mapUrl} class="flex items-center gap-4 font-medium max-w-fit"
					><span class="hover:underline">View on maps </span><span class="material-symbols-outlined"
		...
		<div
			class="hidden {paddingTop} md:flex md:max-w-[25%] lg:max-w-[15%] max-h-full {paddingRight} items-end h-full"
		>
			<img
				alt="Diving cork"
