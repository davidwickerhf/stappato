...
<svelte:head>
	<title>Stappato Team</title>
	<meta name="description" content="Italian Restaurant in Maastricht" />
</svelte:head>

<!-- Landing picture -->

<div class="relative z-0 h-[550px] min-h-[500px] overflow-clip">
	<img
		alt="landing"
		src="images/images/menu.jpg"
	...
	>
		...
		<div class="flex flex-col items-center justify-center gap-6">
			<h1 class="text-5xl uppercase sm:text-6xl md:text-7xl xl:text-8xl">Our Team</h1>
		</div>
	</section>
</div>
